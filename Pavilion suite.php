  		...
  		<?php
	        ...
	        if($roomtype == ""){
	            echo '  <script language="javascript">
	                    ...
	                    window.location="Pavilion suite.php"
	                    </script>
	                ';
	        }
	        if($checkin==Null){
						...
						<div class="oneline-searchbox" style="width:100%px;height:280%;"> 
							...
							<layout>
								<section align="center">
							            <img src="http://www.goldenbeach-resort.com/images/deluxe01.jpg" alt="PAVILION SUITE " style="width:528px;height:328px;"> 
							            <img src="http://www.goldenbeach-resort.com/images/deluxe02.jpg" alt="PAVILION SUITE " style="width:528px;height:328px;">
					      		</section>

					      		<section align="center" >
							            <img src="http://www.goldenbeach-resort.com/images/deluxe03.jpg" alt="PAVILION SUITE " style="width:528px;height:328px;"> 
							            <img src="http://www.goldenbeach-resort.com/images/deluxe04.jpg" alt="PAVILION SUITE " style="width:528px;height:328px;">
					      		</section>

					      		<section align="center" >
							            <img src="http://www.goldenbeach-resort.com/images/deluxe05.jpg" alt="PAVILION SUITE " style="width:528px;height:328px;"> 
							            <img src="http://www.goldenbeach-resort.com/images/deluxe06.jpg" alt="PAVILION SUITE " style="width:528px;height:328px;">
					      		</section>
				      		</layout>
				      		<h1></h1>
				      		<h1></h1>
					      	<center>
						      	...
						      	echo '<td>';
						      	echo '<font color="#FF0000">';
						      	echo '<strike>7,500</strike> 3,750';
						      	echo '</font>';
						      	echo '</td>';

						      	echo '<td>';
						      	echo '<font color="#FF0000">';
						      	echo '<strike>7,500</strike> 5,250';
						      	echo '</font>';
						      	echo '</td>';

						      	echo '<td>';
						      	echo '<font color="#FF0000">';
						      	echo '<strike>7,500</strike> 6,750';
						      	echo '</font>';
						      	echo '</td>';
