        ...
        <div class="col-md-12">
             <div class="row footer">
                    <div class="col-md-6 footer-left">
                        <b>Golden Beach Resort</b><br>
                        254 Moo2, Ao Nang Beach, Muang, Krabi 81000<br>
                        Telephone : +66 (0) 75 637 870-4&nbsp;&nbsp;Fax : +66 (0) 75 637 875<br>
...
<?php 
    ...
    $sql = 'insert into customers_booking_rooms values("","","'.$roomid.'","'.$FirstName.'","'.$LirstName.'","'.$Email.'","'.$Nationality.'","'.$Phone.'","'.$Smoke.'","'.$Floor.'","'.$BedType.'","'.$checkin.'","'.$checkout.'")';
