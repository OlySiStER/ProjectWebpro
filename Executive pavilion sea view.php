  		...
  		<?php
	        ...
	        if($roomtype == ""){
	            echo '  <script language="javascript">
	                    ...
	                    window.location="Executive pavilion sea view.php"
	                    </script>
	                ';
	        }
	        if($checkin==Null){
				...
				<div class="tab-content"> 
	    			<div id="tab-hotel" class="tab-pane active">
						<div class="oneline-searchbox" style="width:100%px;height:280%;"> 
							...
							<font size=5>
							&nbspEXECUTIVE PAVILION SEA VIEW 
							...
							<layout>
								<section align="center">
							            <img src="http://www.goldenbeach-resort.com/images/executive_seaview01.jpg" alt="EXECUTIVE PAVILION SEA VIEW" style="width:528px;height:328px;"> 
							            <img src="http://www.goldenbeach-resort.com/images/executive_seaview02.jpg" alt="EXECUTIVE PAVILION SEA VIEW" style="width:528px;height:328px;">
					      		</section>

					      		<section align="center" >
							            <img src="http://www.goldenbeach-resort.com/images/executive_seaview03.jpg" alt="EXECUTIVE PAVILION SEA VIEW" style="width:528px;height:328px;"> 
							            <img src="http://www.goldenbeach-resort.com/images/executive_seaview04.jpg" alt="EXECUTIVE PAVILION SEA VIEW" style="width:528px;height:328px;">
					      		</section>

					      		<section align="center" >
							            <img src="http://www.goldenbeach-resort.com/images/executive_seaview05.jpg" alt="EXECUTIVE PAVILION SEA VIEW" style="width:528px;height:328px;"> 
							            <img src="http://www.goldenbeach-resort.com/images/executive_seaview06.jpg" alt="EXECUTIVE PAVILION SEA VIEW" style="width:528px;height:328px;">
					      		</section>
				      		</layout>
				      		<h1></h1>
				      		<h1></h1>
					      	<center>
						      	...
						      	echo "Executive Pavilion Sea View";
						      	echo '</font>';
						      	echo '</td>';

						      	echo '<td>';
						      	echo '<font color="#FF0000">';
						      	echo '<strike>11,000</strike> 5,500';
						      	echo '</font>';
						      	echo '</td>';

						      	echo '<td>';
						      	echo '<font color="#FF0000">';
						      	echo '<strike>11,000</strike> 7,770';
						      	echo '</font>';
						      	echo '</td>';

						      	echo '<td>';
						      	echo '<font color="#FF0000">';
						      	echo '<strike>11,000</strike> 8,800';
						      	echo '</font>';
						      	echo '</td>';
						...
						<div class="col-md-12 footer" style="background-color: #FFF; margin: 15px auto; padding: 0px;">
                                <div class="col-md-12">
                                    <div class="row footer">
                                        ...
                                        <div class="col-md-6 footer-right" align="center">
