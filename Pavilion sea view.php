		...
		<?php
	        ...
	        if($roomtype == ""){
	            echo '  <script language="javascript">
	                    ...
	                    window.location="Pavilion sea view.php"
	                    </script>
	                ';
	        }
	        if($checkin==Null){
								...
								<div class="oneline-searchbox" style="width:100%px;height:280%;"> 
									...
									<layout>
										<section align="center">
									            ...
									            <img src="http://www.goldenbeach-resort.com/images/pavilion_seaview02.jpg" alt="SPAVILION SEA VIEW" style="width:528px;height:328px;">
							      		</section>

							      		<section align="center" >
									            <img src="http://www.goldenbeach-resort.com/images/pavilion_seaview03.jpg" alt="PAVILION SEA VIEW" style="width:528px;height:328px;"> 
									            <img src="http://www.goldenbeach-resort.com/images/pavilion_seaview04.jpg" alt="PAVILION SEA VIEW" style="width:528px;height:328px;">
							      		</section>

							      		<section align="center" >
									            <img src="http://www.goldenbeach-resort.com/images/pavilion_seaview05.jpg" alt="PAVILION SEA VIEW" style="width:528px;height:328px;"> 
									            <img src="http://www.goldenbeach-resort.com/images/pavilion_seaview06.jpg" alt="PAVILION SEA VIEW" style="width:528px;height:328px;">
							      		</section>
						      		</layout>
						      		<h1></h1>
						      		<h1></h1>
							      	<center>
								      	...
								      	echo "Pavilion Sea View";
								      	echo '</font>';
								      	echo '</td>';

								      	echo '<td>';
								      	echo '<font color="#FF0000">';
								      	echo '<strike>8,500</strike> 4,250';
								      	echo '</font>';
								      	echo '</td>';

								      	echo '<td>';
								      	echo '<font color="#FF0000">';
								      	echo '<strike>8,500</strike> 5,950';
								      	echo '</font>';
								      	echo '</td>';

								      	echo '<td>';
								      	echo '<font color="#FF0000">';
								      	echo '<strike>8,500</strike> 7,650';
								      	echo '</font>';
								      	echo '</td>';
